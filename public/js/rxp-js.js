...
var RealexHpp = (function () {
  ...
  var internal = {
    ...
    createCloseButton: function (overlayElement) {
      ...
      closeButton.setAttribute("style", "transition: all 0.5s ease-in-out; opacity: 0; float: left; position: absolute; left: 50%; margin-left: 150px; z-index: 99999999; top: calc(50% - 28rem); transform: translate(-50%, -50%)");
