...
export default function NotificationSvg({ fill, stroke, opacity, width }) {
  return (
    <svg
      version='1.0'
      id='Layer_1'
      ...
      x='0px'
      y='0px'
      viewBox='0 0 365.1 392.9'
      width={width || '28px'}
    >
      <path
        d='M175.8,389.9c-4.7-1.3-9.5-2.1-13.9-3.9c-22.5-9.5-35-26.5-37.1-50.9c-0.1-0.6-0.1-1.2-0.2-2.3c-1.6,0-3.1,0-4.5,0
